package com.example.afinocchiaro.studiodigital;
...
//        TextView sourceText = (TextView) rootView.findViewById(R.id.source);
        ...
        protected Boolean doInBackground(Pair<Uri, VrVideoView.Options>... fileInformation) {
            try {
                if (fileInformation == null || fileInformation.length < 1
                    ...
                    videoWidgetView.loadVideoFromAsset("aaa.mp4", options);
                } else {
